...
const (
	UserService_GetUserDetails_FullMethodName   = "/userpb.UserService/GetUserDetails"
	UserService_GetUsers_FullMethodName         = "/userpb.UserService/GetUsers"
	UserService_CreateUpdateUser_FullMethodName = "/userpb.UserService/CreateUpdateUser"
)
...
func (c *userServiceClient) CreateUpdateUser(ctx context.Context, in *CreateUpdateUserRequest, opts ...grpc.CallOption) (*CreateUpdateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_CreateUpdateUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
